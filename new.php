...
<div class="w3-bar w3-white w3-large">
  <a href="hotellist.php" class="w3-bar-item w3-button w3-blue w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Logo</a>
...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="hotel1.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="800">
...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      <img src="room1.jpg" alt="Norway" style="width:100%">
  ...
  <div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
    <div class="w3-half w3-margin-bottom">
      <div class="w3-display-container">
        <img src="hotal1.jpg" alt="Cinque Terre" style="width:100%">
    ...
    <div class="w3-half">
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="hotal2.jpg" alt="New York" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">New York</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="hotal2.jpg" alt="San Francisco" style="width:100%">
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="hotal4.jpg" alt="Pisa" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">Pisa</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="hotal5.jpg" alt="Paris" style="width:100%">
